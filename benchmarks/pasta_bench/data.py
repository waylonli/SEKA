...
from benchmarks.pasta_bench.utils import env_utils, lang_utils
from benchmarks.pasta_bench.utils.typing import Dataset, PathLike, StrSequence
...
def _reformat_bias_in_bios_file(
    ...
    json_file = env_utils.determine_data_dir() / file_name
