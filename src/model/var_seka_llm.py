...
class VarReduceSEKALLM:
    ...
    def attach_projection(
        ...
        pos_lam = self.pos_lam if pos_lam is None else pos_lam
        ...
        P_lam_stack = torch.load(pos_lam, map_location=first_dev)
        ...
        for L in sel_layers:
            ...
            lam_layer = P_lam_stack[L].to(layer_device) # (H,)
            ...
            def _hook(_, __, k_in,
                ...
                lam_layer_reshaped = lam_layer.view(1, H, 1)
                delta = lam_layer_reshaped * pos
